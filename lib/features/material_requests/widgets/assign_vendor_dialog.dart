...
/// moving it to `accepted`. Vendor and expected date are required; PO + remarks optional.
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  validator: (v) =>
                      (v == null || v.trim().isEmpty) ? 'Enter a vendor' : null,
                ),
                const SizedBox(height: 16),
                TextFormField(
                  ...
                  textInputAction: TextInputAction.next,
                  decoration: InputDecoration(
                    labelText: l10n.poNumberOptionalLabel,
                  ),
                ),
                const SizedBox(height: 16),
                TextFormField(
                  ...
                  maxLines: 3,
                  decoration: InputDecoration(
                    labelText: l10n.remarksOptionalLabel,
                  ),
                ),
              ],
            ),
