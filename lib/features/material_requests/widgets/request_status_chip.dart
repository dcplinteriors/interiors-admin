...
/// A coloured chip for the four material-request statuses. (The Projects `StatusChip`
/// only knows project statuses, so requests get their own.) Colours come from the
