...
/// Firebase config for the OneView Admin app.
///
/// Its own web-app registration within the shared `dcpl-interiors` project (distinct
/// appId from the User app; Auth/Firestore/Storage are project-scoped and shared).
...
class DefaultFirebaseOptions {
  ...
  static const FirebaseOptions web = FirebaseOptions(
    ...
    appId: '1:385822650057:web:0926b4981eb21c15d62718',
